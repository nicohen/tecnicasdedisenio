...
public class OfertaTest extends TestCase {
	public void testBid() {
		MockFactory daoFactory = (MockFactory) AbstractProviderFactory.create(Constants.AALOAD);
		...
		user1 = new UserDto("nacho", "Arribalzaga",4356-7890,100, 1,123,1902390, 110289);
		user2 = new UserDto("Anibal", "Lovaglio",4351-7680,190,1, 223,2154356, 230478);
		user3 = new UserDto("Nicolas", "Cohen",43569087,230,3,100,323543,300888);
		user4 = new UserDto("Berta", "Pancho", 58799087,25,5,243,65567,121188);
		user5 = new UserDto("Agustina", "Bazzano",46782903,320,2,450,324545,241299);
